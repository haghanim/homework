...
class Agent():
    ...
    def learn(
        ...
        # 4) Leg(s) in contact?
        is_left_leg_touching, is_right_leg_touching = self.observation_space.low[6], self.observation_space.low[7]
        ...
        if terminated:
            is_lander_body_touching_moon = not (is_left_leg_touching and is_right_leg_touching)
